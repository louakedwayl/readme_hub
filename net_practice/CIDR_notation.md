...
******************************************************************************************************************************************
   ...
   /24 correspond à un masque de 255.255.255.0
        ...
        La notation CIDR (Classless Inter-Domain Routing) est une méthode utilisée pour exprimer les plages d'adresses IP et
leurs masques de sous-réseaux de manière concise. Elle remplace le système ancien basé sur les classes d'adresses (classes A, B, C)
et offre une plus grande flexibilité pour allouer des adresses IP.
...
-------------------
        ...
        Le suffixe après le / indique combien de bits (à partir de la gauche) sont utilisés pour la partie réseau dans 
le masque de sous-réseau. Les bits restants sont pour les hôtes.
