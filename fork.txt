...
du processus parent. Le processus enfant est une copie quasi-identique du parent.
...
Lorsqu’un programme appelle fork(), il est exécuté une seule fois mais retourne deux fois :
    ...
    En cas d’échec (par exemple, manque de ressources), fork() retourne -1 dans le parent 
et ne crée pas de processus enfant.
